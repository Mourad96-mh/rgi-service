...
export const fr = {
  ...
  home: {
    ...
    promoText: 'Les remises en cours, mises à jour en direct depuis la boutique.',
    promoCta: 'Voir toutes les promotions',
    trustTitle: 'Pourquoi Rgi Service',
  },
  promo: {
    emptyTitle: 'Aucune promotion en cours pour le moment. Reviens bientôt !',
    countSingular: 'produit en promotion',
    countPlural: 'produits en promotion',
  },
  trust: {
  ...
  admin: {
    ...
    promoLegend: 'Offre limitée dans le temps',
    promoHelp:
      'Renseigne les trois champs pour lancer une promotion. Le prix promo remplace le prix normal entre les deux dates, puis le produit revient tout seul à son tarif habituel — rien à retirer à la main.',
    fieldPromoPrice: 'Prix promo (MAD)',
    fieldPromoStart: 'Début de la promo',
    fieldPromoEnd: 'Fin de la promo',
    promoClear: 'Retirer la promotion',
    promoErrorIncomplete: 'Renseigne le prix promo, la date de début et la date de fin.',
    promoErrorPrice: 'Le prix promo doit être inférieur au prix normal.',
    promoErrorDates: 'La date de fin doit être postérieure à la date de début.',
