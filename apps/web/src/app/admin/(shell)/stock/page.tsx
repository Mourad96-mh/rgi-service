...
type Search = { low?: string; sort?: 'recent' | 'stock' | 'name'; page?: string };
 ...
 */
export default async function AdminStockPage({ searchParams }: { searchParams: Search }) {
              ...
              <li key={product.id} className="surface-card flex flex-col gap-3 p-4">
                ...
                <dl className="flex flex-wrap gap-x-6 gap-y-3">
                  ...
                  <div>
                    ...
                    <dd>
                      <ThresholdCell id={product.id} threshold={product.lowStockThreshold} />
                    </dd>
                  </div>
                </dl>
              </li>
